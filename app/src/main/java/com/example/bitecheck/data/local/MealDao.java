...
public class MealDao {
    ...
    public long insert(Meal meal) {
        ...
        return helper.getWritableDatabase().insert("meals", null, values);
    }
    ...
    public List<Meal> mealsForDay(String userId, String day) {
        ...
        try (Cursor cursor = helper.getReadableDatabase().query("meals", null,
                "user_id = ? AND logged_at LIKE ?",
                new String[]{userId, day + "%"}, null, null, "logged_at DESC")) {
    ...
    public void delete(long id) {
        helper.getWritableDatabase()
                .delete("meals", "id = ?", new String[]{String.valueOf(id)});
    }
